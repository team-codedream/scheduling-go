 ...
 * @property {string|null} description  - Event details
...
async function createEvent(data) {
  ...
  //   [ userId, calendarId, title, start, end, description ?? null, bgcolor ]
  // );
 ...
 * @param {number} id
 * @param {{ calendarId: number, title: string, start: string, 
 *           end: string, description: string | null, bgcolor: string }} data
...
async function updateEvent(id, data) {
  ...
  //   [ calendarId, title, start, end, description ?? null, bgcolor, id ]
  // );
}
